...
def parse_args():
    parser = argparse.ArgumentParser(description='Parse a list of addresses generated by print_backtrace() into something approximating a stacktrace by extracting information from nm and objdump.')
    ...
    parser.add_argument('-w','--width', type=int, default=2, help='Lines from the objdump to show either side of the target address.', choices=range(0,8))
    ...
    parser.add_argument('-t','--toolchain',default='aarch64-linux-gnu-', help='Prefix for the toolchain to use.')
    parser.add_argument('file', type=argparse.FileType('r'), help="Path to the sos binary (eg. build/projects/aos/sos/sos)")
